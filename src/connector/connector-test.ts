...
function buildTestParams(operation: any, userParams?: string): { header: Record<string, string>; query: Record<string, any>; body: any } {
  const params: { header: Record<string, any>; query: Record<string, any>; body: any } = { header: {}, query: {}, body: {} };
