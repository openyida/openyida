...
const AUTH_TYPE_CODE_MAP: Record<string, number> = {
  'NONE': 0,
  'BasicAuth': 2,
  'ApiKeyAuth': 3,
  'DingAuth': 4,
...
function buildSecurityValue(options: CreateConnectionOptions, authType: string): string {
  switch (authType) {
    case 'BasicAuth':
...
function parseArgs(args: string[]): CreateConnectionOptions {
