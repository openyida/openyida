...
export function getDetailUrl(formInstId) {
  ...
  return 'https://www.aliwork.com/' + appType + '/formDetail/' + FORM_UUID + '?formInstId=' + encodeURIComponent(formInstId) + '&iframe=true&navConfig.layout=1180&isRenderNav=false';
}
```
