---
name: yida-design
description: 生成 prd/<项目名>/design.md，记录主题、布局、组件、页面状态和响应式设计。
---
...
3. `design.md` 写主题、token、视觉风格、布局、背景、材质、圆角、密度、间距、组件、图标、状态和响应式规则。
...
8. **design.md 是唯一视觉依据**：主题、token、页面结构、背景、材质、组件、图标、状态和响应式规则写在 `design.md`。
