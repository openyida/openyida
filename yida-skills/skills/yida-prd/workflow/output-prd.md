...
| --- | --- | --- | --- | --- | --- |
| `home` | <主页面> | display-page / main | <入口和概览> | <10+ contentBlocks：标题上下文、筛选、摘要、主操作、待办、最近记录、动态、提醒、右侧上下文、空态行动等> | <复用 / 创建> |
...
完整应用默认把用户明确要求的核心页面标为“是”。标为“是”的页面必须先完成源码和编译，再逐页创建、发布和回读；标为“否”的页面不得创建线上容器或加入本轮导航。
