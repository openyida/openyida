...
用于单个页面需要感知完整应用时，承接 `yida-prd` 的产品输出。应用字段与独立入口字段按 [前后台导航交接](../../../yida-requirement-analysis/references/handoff.md#前后台导航交接) 区分；下文应用隐藏字段用于全应用 custom，原生提交页/iframe 用于计划选定的原生页面。
