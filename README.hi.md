...
openyida dws <command> [args]                              # DingTalk CLI（संपर्क/कैलेंडर/कार्य/अनुमोदन, आदि）
openyida env                  # वर्तमान AI टूल वातावरण और लॉगिन स्थिति का पता लगाएं
openyida export               # ऐप माइग्रेशन पैकेज निर्यात करें
openyida export-conversation [format]                      # AI बातचीत इतिहास निर्यात करें
openyida flash-to-prd <appType> [options]                  # फ्लैश नोट को PRD में बदलें（मीटिंग पहचान समर्थित）
...
openyida integration create <appType> [options]             # एकीकरण और स्वचालन प्रवाह बनाएं
...
openyida task-center [filter]                              # वैश्विक कार्य केंद्र（कार्य/बनाया गया/प्रोसेस्ड/सीसी/सबमिट）
