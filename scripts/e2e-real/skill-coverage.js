...
const SKILL_COVERAGE = {
  ...
  'yida-openyida-cli-fast-publish': { level: 'offline-unit', tests: ['skill metadata and packaging validation', 'routing eval scenarios'], reason: 'CLI fast-publish is a cross-cutting agent workflow that accelerates OpenYida delivery by avoiding browser-tool latency; validate its metadata, packaging, and routing without mutating live resources' },
