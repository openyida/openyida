...
const SKILL_COVERAGE = {
  ...
  'yida-requirement-analysis': { level: 'offline-unit', tests: ['skill metadata and packaging validation', 'routing eval scenarios', 'tests/skill-contracts.test.js'], reason: 'requirement analysis only writes a local shared brief for yida-prd and yida-design; validate routing, packaging, and parallel handoff contracts without mutating Yida resources' },
  'yida-prd': { level: 'offline-unit', tests: ['skill metadata and packaging validation', 'routing eval scenarios', 'tests/skill-contracts.test.js', 'tests/yida-prd-quality-fixtures.test.js'], reason: 'PRD generation produces local prd.md only; validate routing, packaging and document contracts without mutating Yida resources' },
  'yida-design': { level: 'offline-unit', tests: ['skill metadata and packaging validation', 'routing eval scenarios', 'tests/create-form.test.js', 'tests/skill-contracts.test.js'], reason: 'visual direction and theme token guidance produce design.md in parallel with yida-prd; validate routing, packaging, skill contracts and form theme payloads rather than mutating Yida resources or tenant-wide theme config' },
