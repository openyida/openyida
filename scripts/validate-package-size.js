...
// Includes the latest main assets/process support, CodeBundle download/publish,
// and native form attachment upload (one module and two skill files).
// Node 20/24 package measurements are rounded up to the next 16 KiB boundary.
const MAX_TARBALL_BYTES = 1840 * 1024;
const MAX_UNPACKED_BYTES = 6272 * 1024;
// Includes both asset delivery files, process action files, and attachment upload files.
