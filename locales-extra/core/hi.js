...
module.exports = {
  ...
  login: {
    ...
    device_title: 'डिवाइस कोड लॉगिन:',
    device_open: 'खोलें',
    device_enter_code: 'कोड दर्ज करें:',
    device_or_direct: 'या सीधे खोलें:',
    device_completed: 'डिवाइस प्राधिकरण पूरा हुआ।',
    device_timeout: 'डिवाइस प्राधिकरण का समय समाप्त हो गया; डिवाइस कोड अभी भी सत्यापन की प्रतीक्षा में हो सकता है',
    device_missing_params: 'डिवाइस कोड प्रवाह के लिए authBaseUrl और clientId आवश्यक हैं',
    device_poll_missing_params: 'डिवाइस टोकन पोलिंग के लिए authBaseUrl, clientId और deviceCode आवश्यक हैं',
    device_invalid_code_response: 'प्रमाणीकरण सेवा ने उपयोग योग्य डिवाइस कोड नहीं लौटाया',
    device_code_expired: 'डिवाइस कोड समाप्त हो गया; login --device फिर से चलाएँ',
    device_access_denied: 'सत्यापन पृष्ठ पर प्राधिकरण अस्वीकार कर दिया गया',
    device_2xx_no_token: 'प्रमाणीकरण सेवा ने accessToken के बिना 2xx लौटाया',
