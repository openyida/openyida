...
module.exports = {
  help: {
    ...
    cmd_schema_validate: 'Schema-as-Code manifest को स्थानीय रूप से सत्यापित करें',
    cmd_schema_plan: 'रीड-ओनली रिमोट अवलोकन से Schema-as-Code बदलावों की योजना बनाएं',
    cmd_schema_apply: 'चेकपॉइंट और रिकवरी सुरक्षा के साथ समीक्षित Schema-as-Code योजना लागू करें',
