...
module.exports = {
  ...
  login: {
    ...
    device_title: 'Connexion par code d’appareil :',
    device_open: 'Ouvrir',
    device_enter_code: 'Saisissez le code :',
    device_or_direct: 'Ou ouvrez directement :',
    device_completed: 'Autorisation de l’appareil terminée.',
    device_timeout: 'Délai d’autorisation de l’appareil dépassé ; le code peut encore être en attente de vérification',
    device_missing_params: 'Le flux de code d’appareil nécessite authBaseUrl et clientId',
    device_poll_missing_params: 'L’interrogation du jeton d’appareil nécessite authBaseUrl, clientId et deviceCode',
    device_invalid_code_response: 'Le service d’authentification n’a pas renvoyé de code d’appareil utilisable',
    device_code_expired: 'Le code d’appareil a expiré ; relancez login --device',
    device_access_denied: 'L’autorisation a été refusée sur la page de vérification',
    device_2xx_no_token: 'Le service d’authentification a renvoyé 2xx sans accessToken',
