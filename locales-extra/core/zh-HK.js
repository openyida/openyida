...
module.exports = {
  help: {
    ...
    cmd_schema_validate: '本機校驗 Schema-as-Code Manifest',
    cmd_schema_plan: '唯讀觀測遠端並規劃 Schema-as-Code 變更',
    cmd_schema_apply: '使用 checkpoint 與恢復護欄執行已審閱的 Schema-as-Code 計劃',
    group_data: '資料 & 權限',
