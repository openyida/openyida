...
module.exports = {
  ...
  login: {
    ...
    device_title: '裝置碼登入：',
    device_open: '開啟',
    device_enter_code: '輸入驗證碼：',
    device_or_direct: '或直接開啟：',
    device_completed: '裝置授權完成。',
    device_timeout: '裝置授權逾時；裝置碼可能仍在等待驗證',
    device_missing_params: '裝置碼流程需要 authBaseUrl 和 clientId',
    device_poll_missing_params: '裝置權杖輪詢需要 authBaseUrl、clientId 和 deviceCode',
    device_invalid_code_response: '認證服務未傳回可用的裝置碼',
    device_code_expired: '裝置碼已過期；請重新執行 login --device',
    device_access_denied: '授權已在驗證頁面被拒絕',
    device_2xx_no_token: '認證服務傳回 2xx 但未包含 accessToken',
