...
module.exports = {
  ...
  login: {
    ...
    device_title: 'تسجيل الدخول برمز الجهاز:',
    device_open: 'افتح',
    device_enter_code: 'أدخل الرمز:',
    device_or_direct: 'أو افتح مباشرة:',
    device_completed: 'اكتمل تفويض الجهاز.',
    device_timeout: 'انتهت مهلة تفويض الجهاز؛ قد يظل رمز الجهاز في انتظار التحقق',
    device_missing_params: 'يتطلب تدفق رمز الجهاز authBaseUrl و clientId',
    device_poll_missing_params: 'يتطلب استقصاء رمز الجهاز authBaseUrl و clientId و deviceCode',
    device_invalid_code_response: 'لم تُرجع خدمة المصادقة رمز جهاز صالحًا للاستخدام',
    device_code_expired: 'انتهت صلاحية رمز الجهاز؛ شغّل login --device مرة أخرى',
    device_access_denied: 'تم رفض التفويض في صفحة التحقق',
    device_2xx_no_token: 'أرجعت خدمة المصادقة 2xx بدون accessToken',
