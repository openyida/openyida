...
module.exports = {
  help: {
    ...
    cmd_schema_validate: 'التحقق محلياً من بيان Schema-as-Code',
    cmd_schema_plan: 'تخطيط تغييرات Schema-as-Code بمراقبة بعيدة للقراءة فقط',
    cmd_schema_apply: 'تطبيق خطة Schema-as-Code مراجعة مع نقاط تحقق وحماية للاسترداد',
