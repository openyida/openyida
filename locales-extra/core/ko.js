...
module.exports = {
  ...
  login: {
    ...
    device_title: '기기 코드 로그인:',
    device_open: '열기',
    device_enter_code: '코드 입력:',
    device_or_direct: '또는 직접 열기:',
    device_completed: '기기 인증이 완료되었습니다.',
    device_timeout: '기기 인증 시간이 초과되었습니다. 기기 코드가 아직 확인 대기 중일 수 있습니다',
    device_missing_params: '기기 코드 흐름에는 authBaseUrl과 clientId가 필요합니다',
    device_poll_missing_params: '기기 토큰 폴링에는 authBaseUrl, clientId, deviceCode가 필요합니다',
    device_invalid_code_response: '인증 서비스가 사용 가능한 기기 코드를 반환하지 않았습니다',
    device_code_expired: '기기 코드가 만료되었습니다. login --device를 다시 실행하세요',
    device_access_denied: '확인 페이지에서 인증이 거부되었습니다',
    device_2xx_no_token: '인증 서비스가 accessToken 없이 2xx를 반환했습니다',
