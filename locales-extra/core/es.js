...
module.exports = {
  ...
  login: {
    ...
    device_title: 'Inicio de sesión con código de dispositivo:',
    device_open: 'Abrir',
    device_enter_code: 'Introduce el código:',
    device_or_direct: 'O abre directamente:',
    device_completed: 'Autorización del dispositivo completada.',
    device_timeout: 'Se agotó el tiempo de autorización del dispositivo; el código puede seguir pendiente de verificación',
    device_missing_params: 'El flujo de código de dispositivo requiere authBaseUrl y clientId',
    device_poll_missing_params: 'La consulta del token de dispositivo requiere authBaseUrl, clientId y deviceCode',
    device_invalid_code_response: 'El servicio de autenticación no devolvió un código de dispositivo válido',
    device_code_expired: 'El código de dispositivo ha caducado; ejecuta login --device de nuevo',
    device_access_denied: 'La autorización fue rechazada en la página de verificación',
    device_2xx_no_token: 'El servicio de autenticación devolvió 2xx sin accessToken',
