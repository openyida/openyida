...
module.exports = {
  ...
  login: {
    ...
    device_title: 'Đăng nhập bằng mã thiết bị:',
    device_open: 'Mở',
    device_enter_code: 'Nhập mã:',
    device_or_direct: 'Hoặc mở trực tiếp:',
    device_completed: 'Đã hoàn tất cấp quyền thiết bị.',
    device_timeout: 'Quá thời gian cấp quyền thiết bị; mã thiết bị có thể vẫn đang chờ xác minh',
    device_missing_params: 'Luồng mã thiết bị yêu cầu authBaseUrl và clientId',
    device_poll_missing_params: 'Việc thăm dò token thiết bị yêu cầu authBaseUrl, clientId và deviceCode',
    device_invalid_code_response: 'Dịch vụ xác thực không trả về mã thiết bị hợp lệ',
    device_code_expired: 'Mã thiết bị đã hết hạn; hãy chạy lại login --device',
    device_access_denied: 'Quyền truy cập đã bị từ chối trên trang xác minh',
    device_2xx_no_token: 'Dịch vụ xác thực trả về 2xx nhưng không có accessToken',
