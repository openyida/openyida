...
module.exports = {
  help: {
    ...
    cmd_schema_validate: 'Xác thực manifest Schema-as-Code cục bộ',
    cmd_schema_plan: 'Lập kế hoạch thay đổi Schema-as-Code với quan sát từ xa chỉ đọc',
    cmd_schema_apply: 'Áp dụng kế hoạch Schema-as-Code đã duyệt với checkpoint và bảo vệ khôi phục',
