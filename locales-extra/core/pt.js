...
module.exports = {
  help: {
    ...
    cmd_schema_validate: 'Validar localmente o manifesto Schema-as-Code',
    cmd_schema_plan: 'Planejar alterações Schema-as-Code com observação remota somente leitura',
    cmd_schema_apply: 'Aplicar um plano Schema-as-Code revisado com checkpoints e proteções de recuperação',
