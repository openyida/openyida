...
module.exports = {
  ...
  login: {
    ...
    device_title: 'Login com código do dispositivo:',
    device_open: 'Abrir',
    device_enter_code: 'Digite o código:',
    device_or_direct: 'Ou abra diretamente:',
    device_completed: 'Autorização do dispositivo concluída.',
    device_timeout: 'A autorização do dispositivo expirou; o código ainda pode estar aguardando verificação',
    device_missing_params: 'O fluxo de código do dispositivo requer authBaseUrl e clientId',
    device_poll_missing_params: 'A consulta do token do dispositivo requer authBaseUrl, clientId e deviceCode',
    device_invalid_code_response: 'O serviço de autenticação não retornou um código de dispositivo válido',
    device_code_expired: 'O código do dispositivo expirou; execute login --device novamente',
    device_access_denied: 'A autorização foi negada na página de verificação',
    device_2xx_no_token: 'O serviço de autenticação retornou 2xx sem accessToken',
