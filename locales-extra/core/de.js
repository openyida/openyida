...
module.exports = {
  ...
  login: {
    ...
    device_title: 'Anmeldung mit Gerätecode:',
    device_open: 'Öffnen',
    device_enter_code: 'Code eingeben:',
    device_or_direct: 'Oder direkt öffnen:',
    device_completed: 'Geräteautorisierung abgeschlossen.',
    device_timeout: 'Zeitüberschreitung bei der Geräteautorisierung; der Gerätecode wartet möglicherweise noch auf Bestätigung',
    device_missing_params: 'Der Gerätecode-Ablauf benötigt authBaseUrl und clientId',
    device_poll_missing_params: 'Die Geräte-Token-Abfrage benötigt authBaseUrl, clientId und deviceCode',
    device_invalid_code_response: 'Der Authentifizierungsdienst hat keinen verwendbaren Gerätecode zurückgegeben',
    device_code_expired: 'Der Gerätecode ist abgelaufen; führen Sie login --device erneut aus',
    device_access_denied: 'Die Autorisierung wurde auf der Bestätigungsseite abgelehnt',
    device_2xx_no_token: 'Der Authentifizierungsdienst gab 2xx ohne accessToken zurück',
