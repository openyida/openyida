...
module.exports = {
  help: {
    ...
    cmd_schema_validate: 'Schema-as-Code マニフェストをローカル検証',
    cmd_schema_plan: '読み取り専用のリモート観測で Schema-as-Code 変更を計画',
    cmd_schema_apply: 'チェックポイントと復旧ガード付きでレビュー済み Schema-as-Code 計画を適用',
    group_data: 'データ & 権限',
