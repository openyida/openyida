...
module.exports = {
  ...
  login: {
    ...
    device_title: 'デバイスコードでログイン:',
    device_open: '開く',
    device_enter_code: 'コードを入力:',
    device_or_direct: 'または直接開く:',
    device_completed: 'デバイスの認証が完了しました。',
    device_timeout: 'デバイス認証がタイムアウトしました。デバイスコードはまだ確認待ちの可能性があります',
    device_missing_params: 'デバイスコードフローには authBaseUrl と clientId が必要です',
    device_poll_missing_params: 'デバイストークンのポーリングには authBaseUrl、clientId、deviceCode が必要です',
    device_invalid_code_response: '認証サービスから有効なデバイスコードが返されませんでした',
    device_code_expired: 'デバイスコードの有効期限が切れました。login --device を再実行してください',
    device_access_denied: '確認ページで認証が拒否されました',
    device_2xx_no_token: '認証サービスが accessToken を含まない 2xx を返しました',
