...
function decodeManifestV2(bytes) {
  ...
  if (!exactKeys(m, ['schemaVersion', 'product', 'runtimeVersion', 'sourceRevision', 'platform', 'arch', 'launcherProtocol', 'wireProtocol', 'stateSchema', 'binary', 'releaseId', 'keyId']) ||
      ...
      !['darwin', 'linux', 'win32'].includes(m.platform) || !['arm64', 'x64'].includes(m.arch) ||
...
module.exports = { MAX_MANIFEST_BYTES, MAX_BINARY_BYTES, SHA256, decodeManifestV2, verifyManifestSignature, parseStrictJson, exactKeys };
