...
# 编写仪表盘代码（使用 yida-canvas-custom-page 技能）
# 源码推荐保存为 project/pages/src/ipd-dashboard.canvas.jsx
openyida publish project/pages/src/ipd-dashboard.canvas.jsx <appType> <formUuid>
*/
