 ...
 * 
 * 使用说明：
 * 1. 复制此模板到 project/pages/src/xxx.jsx
 * 2. 修改 _customState 初始状态
 * 3. 在 renderJsx 中编写页面 JSX
 * 4. 运行 openyida check-page project/pages/src/xxx.jsx 检查宜搭规范
 * 5. 运行 openyida compile project/pages/src/xxx.jsx 验证语法
 * 6. 运行 openyida publish project/pages/src/xxx.jsx <appType> <formUuid> 发布
 * 
 * ⚠️ 重要约束：
