...
var REPORT_COMPONENTS = {
  totalCount: { cid: 'node_ocqwjq2xg6a5sx', className: 'YoushuSimpleIndicatorCard', dataSetKey: 'youshuData' },
  totalBudget: { cid: 'node_ocwktu31n7eulc', className: 'YoushuSimpleIndicatorCard', dataSetKey: 'youshuData' },
  avgProgress: { cid: 'node_oc8owv8lt5b9ss', className: 'YoushuSimpleIndicatorCard', dataSetKey: 'youshuData' },
  statusTable: { cid: 'node_ocrrw4dzf6mq9z', className: 'YoushuTable', dataSetKey: 'table' },
  budgetTable: { cid: 'node_oc0p5ch9y8n4cd', className: 'YoushuTable', dataSetKey: 'table' },
};
