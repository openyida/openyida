...
var PALETTE = {primary: '#2563EB', primaryLight: '#60A5FA', accent: '#F97316', success: '#22C55E', warning: '#D97706', danger: '#DC2626', neutral: '#64748B', bg: '#F8FAFC', cardBg: '#FFFFFF', border: '#E2E8F0', textPrimary: '#1D2939', textSecondary: '#475569', textMuted: '#94A3B8'};
...
export function renderScatterChart() {
  ...
  var series = categories.map(function(cat, index) {
    ...
    return {
      ...
      emphasis: {
        focus: 'series',
        itemStyle: { opacity: 1, borderColor: '#475569', borderWidth: 1 },
      },
    };
  });
