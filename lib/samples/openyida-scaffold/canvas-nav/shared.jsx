...
const CANVAS_NAV_CSS = `
  ...
  .oy-canvas-nav .oy-nav-item {
    ...
    min-height: var(--pod-nav-menu-item-height, 40px); padding: var(--pod-nav-menu-item-padding, 8px 12px);
    border: var(--pod-nav-menu-item-border, none); border-radius: var(--pod-nav-menu-item-radius, 8px); background: transparent;
    color: var(--pod-nav-item-text-color, var(--color-text1-4, #1f2329)); font: inherit; font-size: var(--pod-nav-menu-font-size, 14px); line-height: var(--pod-nav-menu-line-height, 20px); text-decoration: none; text-align: start; cursor: pointer;
  }
