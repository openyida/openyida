/**
 * 闪记转会议需求稿 — Prompt 构建模块
 *
 * 将钉钉闪记（会议录音转文字）内容转化为会议需求稿，
 * 调用 txtFromAI 接口生成会议需求稿。
 *
 * 核心设计思路：
...
请分析以下钉钉闪记内容，从中提取产品需求，并按 PRD 生成规则生成会议需求稿。${projectHint}${industryHint}
