...
async function run(args) {
  ...
  const result = {
    ...
    connectorName: detail.connectorName || connector.connectorName,
    detail: { ...detail, id: detail.id === undefined ? connector.id : detail.id },
  };
  if (json) {
  ...
  console.log(`连接器名: ${result.connectorName || '-'}`);
