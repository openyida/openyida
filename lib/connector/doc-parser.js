...
exports.DocParserFactory = exports.MarkdownParser = void 0;
exports.parseAPIDoc = parseAPIDoc;
exports.convertToOperationConfig = convertToOperationConfig;
...
class MarkdownParser extends BaseDocParser {
    ...
    parseResponseSchema() {
        ...
        for (let i = 0; i < lines.length; i++) {
            ...
            if (!line || line.match(/^#/) || line.includes('HTTP 状态码')) {
                continue;
            }
...
exports.DocParserFactory = DocParserFactory;
/**
 * 解析 API 文档主函数
 */
...
function convertToOperationConfig(parseResult) {
    ...
    if (parseResult.requestInfo.body && parseResult.requestInfo.body.schema) {
        ...
        const requestExample = (0, response_parser_1.generateExample)(requestSchema);
        operation.parameters.body = {
            default: JSON.stringify(requestExample)
        };
        const requestChildList = (0, response_parser_1.generateChildList)(requestSchema, operation.operationId);
    ...
    if (parseResult.responseInfo.schema) {
        ...
        if (!operation.parameters.body) {
            const example = (0, response_parser_1.generateExample)(responseSchema);
            operation.parameters.body = {
                default: JSON.stringify(example)
            };
        }
        operation.outputs = [(0, response_parser_1.generateOutputs)(responseSchema, operation.operationId)];
    }
    else {
