...
const CHART_COMPONENT_MAP = Object.freeze(Object.fromEntries(
  Object.entries(REPORT_CHART_CAPABILITIES).map(([type, entry]) => [type, entry.componentName])
));
const BASE_COMPONENTS = REPORT_BASE_COMPONENTS;
