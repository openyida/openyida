...
const FORM_POST_WRITE_READBACK_MAX_ATTEMPTS = 6;
const FORM_POST_WRITE_READBACK_DELAY_MS = 500;
...
function postWriteReadbackRetry(runtime, proposedStateResource) {
  if (shouldWaitForAppCreatePostWriteReadback(runtime, proposedStateResource)) {
    return {
      ...appCreatePostWriteReadbackRetryOptions(runtime.context.options),
      shouldRetry: isAppCreatePostWriteReadbackMissing,
    };
  }
