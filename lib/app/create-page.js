...
const { readRenderNav, buildDisplayPageEntryUrls } = require('./application-entry-urls');
  ...
  if (response && response.success && response.content) {
    ...
    if (options.hideNav) {
      ...
      if (navigationVerification.verified) {
        ...
        pageUrl = buildDisplayPageEntryUrls({
          appType, formUuid: pageId, baseUrl: authRef.baseUrl,
          config: { formType: 'display', renderNav: navigationVerification.renderNav },
        }).standaloneUrl;
      } else {
