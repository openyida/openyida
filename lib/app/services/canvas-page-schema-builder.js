...
function openyidaNormalizeConnectorInputs(inputs) {
  ...
  return {
    ...
    body: Object.prototype.hasOwnProperty.call(source, 'body') ? source.body : {}
  };
}

function openyidaCreateConnectorApiBridge() {
  function invoke(binding, inputs) {
    if (!binding || !binding.connectorId || !binding.operationId) {
      return Promise.reject(new Error('connectorId and operationId are required'));
    }
    var connectorInfo = {
    ...
    var body = 'inputs=' + encodeURIComponent(JSON.stringify(openyidaNormalizeConnectorInputs(inputs)))
    ...
    return window.fetch(endpoint, {
      ...
      if (!payload || payload.success === false || payload.hasError === true) {
        throw new Error(payload && (payload.errorMsg || payload.message) || 'connector invocation failed');
      }
        ...
        componentsTree: [
          {
            ...
            condition: true,
            css: '.vc-page-yida-page{--yida-form-content-padding:0;--yida-form-content-margin:0;--yida-layout-padding:0}.vc-deep-container-entry.vc-rootcontent{padding:0!important;margin-top:0!important;margin-right:0!important;margin-bottom:0!important;margin-left:0!important}',
            methods: {
              __initMethods__: {
                type: 'js',
