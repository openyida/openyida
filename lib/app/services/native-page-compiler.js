...
const { NATIVE_PAGE_PROFILE } = require('../page-compiler-routing');
...
function compileNativePageSource(loadedSource) {
  ...
  if (loadedSource.profile !== NATIVE_PAGE_PROFILE) {
    compilerError('SCHEMA_PAGE_COMPILER_MISMATCH', 'Native page compiler cannot compile a Canvas page source.', {
      expectedProfile: NATIVE_PAGE_PROFILE,
      actualProfile: loadedSource.profile,
    });
  }
