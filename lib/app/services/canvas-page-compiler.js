...
const { CANVAS_PAGE_PROFILE } = require('../page-compiler-routing');
...
function compileCanvasPageSource(loadedSource) {
  ...
  if (loadedSource.profile !== CANVAS_PAGE_PROFILE) {
    compilerError('SCHEMA_PAGE_COMPILER_MISMATCH', 'Canvas page compiler cannot compile a native page source.', {
      expectedProfile: CANVAS_PAGE_PROFILE,
