...
function buildScaffoldContracts() {
  return {
    ...
    canvas: {
      ...
      design_config_option: '--design-config <design-runtime.json>',
      project_output_path: '.cache/openyida/<project>/scaffolds/canvas.canvas.jsx',
    ...
    native_form: {
      ...
      design_config_option: '--design-config <design-runtime.json>',
      project_output_path: '.cache/openyida/<project>/scaffolds/form.form.json',
