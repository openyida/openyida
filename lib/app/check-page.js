...
const { warn, hint, success, info } = require('../core/chalk');
...
async function run(args) {
  ...
  if (resolvePageCompilerMode(sourcePath) === PAGE_COMPILER_MODE_CANVAS) {
    const result = compileCanvasLocal(sourceCode, { sourcePath });
    const output = {
      ok: true,
      mode: 'canvas',
      sourcePath,
