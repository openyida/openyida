...
const COMMAND_GROUPS = [
  ...
  },
  {
    ...
    commands: [
      ...
      command('integration.detail-log', ['integration', 'detail-log'], 'integration detail-log <appType> <procInstId> [--json] [--include-params]', 'help.cmd_integration_detail_log', {
        output: 'text|json',
      }),
