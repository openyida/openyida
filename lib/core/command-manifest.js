...
const COMMAND_GROUPS = [
  ...
  },
  {
    ...
    commands: [
      ...
      command('agent', ['agent'], 'agent <doctor|status|connect|run|disconnect|logout> [options]', 'help.cmd_agent', {
        requiresLogin: false,
        output: 'json',
        examples: ['openyida agent doctor --json', 'openyida agent run --help'],
      }),
