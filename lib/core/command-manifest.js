  ...
  return {
    ...
    core_workflows: {
      full_app_build: {
        ...
        page_skill_policy: 'New custom pages use Code Canvas. yida-canvas-custom-page owns Code Canvas page implementation rules. OpenYida provides one complete canvas.canvas.jsx scaffold with 13 Yida APIs, theme, form submission/detail drawer, URL builders, instance-id validation, iframe theme sync, and base state. Use yida-custom-page only when the user explicitly asks to modify an existing non-CodeCanvas Jsx/renderJsx page.',
        page_creation_policy: 'Create only custom pages that will be implemented and published in the current run. Keep later-step pages in the PRD and do not call create-page for them.',
        form_entry_policy: 'Code Canvas submission and detail actions use the scaffold FormOpenContainer drawer on all devices; mobile uses a full-screen drawer. Use full-page or new-tab navigation only when the user explicitly requests it.',
        ...
        default_seed_data: {
          ...
          run_in_parallel_with: ['create-page', 'yida-canvas-custom-page'],
        ...
        completion_contract: 'Follow the yida-app stage table, publish the primary page, apply lightweight navigation sorting when required, then return 2-3 business-summary sentences followed by one primary user-facing link. Do not default to resource ID tables or long URL lists.',
      },
    },
  };
}
