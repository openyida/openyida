...
const COMMAND_SIDE_EFFECTS = new Map([
  ...
  ['data', sideEffect('mixed', {
    ...
    mutating_actions: ['create', 'update', 'upload-attachment', 'delete'],
  })],
...
const COMMAND_PERMISSIONS = new Map([
  ...
  ...permissionEntries([
    ...
    preauthorized_actions: ['create', 'update', 'upload-attachment'],
    ask_actions: ['delete'],
  })),
  ...
  },
  {
    ...
    commands: [
      ...
      command(
        'data.upload-attachment.form',
        ['data', 'upload-attachment', 'form'],
        'data upload-attachment form <appType> <formUuid> --inst-id <formInstId> --attachment-field <attachmentField_xxx> --file <path> [--file <path> ...] [--append] [--concurrency <1-5>] [--dry-run]',
        'help.cmd_data_upload_attachment',
        { output: 'json' }
      ),
