  ...
  return {
    ...
    core_workflows: {
      full_app_build: {
        ...
        ui_guidance_policy: 'yida-design writes prd/<project>/prd.md and prd/<project>/design.md. Page implementation reads both files. page-spec.json is only a derived implementation handoff for generators, not a third design source.',
