  ...
  return {
    ...
    core_workflows: {
      full_app_build: {
        ...
        product_design_policy: 'Full app creation loads yida-app. yida-requirement-analysis writes one shared requirement brief. yida-prd and yida-design start in parallel; yida-design also derives design-runtime.json and project form/Canvas scaffolds. yida-app validates the PRD and design after both are ready, then derives page-spec.json for the current page.',
        ui_guidance_policy: 'prd.md stores business facts and design.md stores visual facts. design-runtime.json and project scaffolds are derived from design.md. page-spec.json is derived after PRD/design alignment. Page implementation consumes page-spec.json plus the project Canvas scaffold and rereads PRD/design only when design changes or derived artifacts conflict.',
