...
const COMMAND_PERMISSIONS = new Map([
  ...
  ...permissionEntries([
    ...
    preauthorized_actions: ['login', 'sync-dws', 'refresh', 'logout', 'profile switch'],
  })),
...
const COMMAND_GROUPS = [
  {
    ...
    commands: [
      ...
      command('auth', ['auth'], 'auth <status|login|sync-dws|refresh|logout|profiles|profile switch>', 'help.cmd_auth', { requiresLogin: false }),
