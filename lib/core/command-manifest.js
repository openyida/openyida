  ...
  return {
    ...
    core_workflows: {
      full_app_build: {
        ...
        product_design_policy: 'Full app creation loads yida-app. yida-app first confirms target resources, then follows its workflow files to create or reuse resources, implement pages, publish the primary page, and return one primary link.',
        ui_guidance_policy: 'yida-prd writes prd/<project>/prd.md; yida-design writes prd/<project>/design.md. Page implementation reads both files. page-spec.json is only a derived implementation handoff for generators, not a third design source.',
