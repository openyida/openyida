...
const COMMAND_GROUPS = [
  ...
  },
  {
    ...
    commands: [
      ...
      command('check-prd-completeness', ['check-prd-completeness'], 'check-prd-completeness <prd.md> --app-type <appType> [--json]', 'help.cmd_check_prd_completeness', {
        output: 'json',
      }),
    ...
    core_workflows: {
      full_app_build: {
        ...
        recommended_read_commands: [
          ...
          'openyida check-prd-completeness prd/<project>/prd.md --app-type <appType> --json',
        ],
