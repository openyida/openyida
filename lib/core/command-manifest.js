  ...
  return {
    ...
    core_workflows: {
      full_app_build: {
        ...
        form_visual_guidance_policy: 'Native forms use the independent .form.json scaffold. Extend fields, Divider/column groups, validations, rules, remote data sources, theme tokens, and formDetail preset there. OpenYida generates and validates the native Schema through form-schema-builder.js and form-runtime.js. Do not write a native form as custom-page JSX.',
