...
const COMMAND_SIDE_EFFECTS = new Map([
  ...
  ['asset', sideEffect('mixed', {
    mutates_yida: false,
    mutates_local: true,
    read_actions: ['status', 'sources', 'resolve --slot', 'resolve --input'],
    mutating_actions: ['resolve --manifest', 'resolve --upload-assets'],
  })],
...
const COMMAND_PERMISSIONS = new Map([
  ...
  ...permissionEntries([
    ...
    preauthorized_actions: ['resolve --manifest', 'resolve --upload-assets'],
  })),
