...
Commands:
  ...
  compile <fichierSource>                                      Compiler JSX uniquement (sans publier, sortie dans pages/dist/)
...
`,
    ...
    integration_help: `Utilisation: openyida integration <sous-commande> [args]

Sous-commandes:
  create <appType> <formUuid> <flowName> [options]   Créer une intégration & automatisation (flux logique)

Exemples:
  openyida integration create APP_XXX FORM-XXX "Notification nouvel enregistrement" --receivers user123 --publish`,
...
📄 Création de la page personnalisée...`,
    ...
    url_label: '  URL: {0}',
    failed: '  ❌ Échec de la création : {0}',
    datasource_injecting: '  [datasource] Injection de {0} source(s) de données connecteur...',
    datasource_success: '  [datasource] Source de données injectée avec succès',
    datasource_failed: '  [datasource] Échec de l\'injection de la source de données : {0}',
    invalid_response: '❌ Échec de la création de la page : pageId invalide retourné par le serveur, veuillez vérifier si appType est correct',
  },
...
🎉 Nouvelle version disponible : {0} → {1}`,
  ...
  // ── lib/compile.js ─────────────────────────────────
  compile: {
    usage: 'Usage: openyida compile <fichier-source>',
    example: 'Exemple: openyida compile pages/src/demo.js',
    source_not_found: '❌ Fichier source introuvable : {0}',
    success: '✅ Compilation terminée !',
    output_file: '  Fichier de sortie : {0}',
