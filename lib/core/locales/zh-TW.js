...
module.exports = {
  ...
  help: {
    subtitle: '宜搭低代碼 AI 開發工具',
    usage: '用法:',
    alias: '別名:',
    group_auth: '環境 & 認證',
    cmd_login: '登入（優先快取，--qr 或 --codex 瀏覽器登入）',
    cmd_logout: '登出 / 切換帳號',
    cmd_auth: '登入態管理',
    cmd_org: '組織管理（列出 / 切換）',
    cmd_env: '偵測 AI 工具環境和登入態',
    group_app: '應用管理',
    cmd_app_list: '查詢我的應用清單',
    cmd_create_app: '建立宜搭應用',
    cmd_update_app: '更新應用資訊',
    cmd_export: '匯出應用（產生遷移包）',
    cmd_import: '匯入遷移包，重建應用',
    group_form: '表單 & 頁面',
    ...
    cmd_save_share: '儲存公開存取 / 分享設定',
    cmd_get_page_config: '查詢頁面公開存取設定',
    group_report: '報表',
    ...
    cmd_cdn: 'CDN 圖片管理（設定/上傳/重新整理）',
    quickstart_title: '快速上手',
    quickstart_app_name: '考勤管理',
    quickstart_form_name: '員工資訊',
    docs: '📚 文件:',
  },
...
`,
    ...
    integration_help: '用法：openyida integration create <appType> <formUuid> <flowName> [選項]',
    ...
    compile_example: '範例：openyida compile pages/src/home.jsx',
    check_page_usage: '用法: openyida check-page <源文件路径> [--json]',
    check_page_example: '示例: openyida check-page pages/src/home.jsx --json',
    generate_page_usage: '用法: openyida generate-page product-homepage --output pages/src/home.jsx [--spec page.json] [--compile]',
    generate_page_example: '示例: openyida generate-page product-homepage --brand-name OpenKuma --brand-initials OK --output pages/src/home.jsx --compile',
  ...
  qr_login: {
    ...
    target_corp_not_found: '未在可存取組織中找到指定 corpId：{0}',
...
選項：
  ...
  codex_login: {
    ...
    cache_available: '已存在可用的 CLI Cookie 快取，無需重新開啟瀏覽器登入。',
  },
};
