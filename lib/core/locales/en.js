...
`,
  ...
  login: {
    ...
    device_title: 'Device code login:',
    device_open: 'Open',
    device_enter_code: 'Enter code:',
    device_or_direct: 'Or open directly:',
    device_completed: 'Device authorization completed.',
    device_timeout: 'device authorization timed out; device code may still be pending',
    device_missing_params: 'device code flow requires authBaseUrl and clientId',
    device_poll_missing_params: 'device token polling requires authBaseUrl, clientId and deviceCode',
    device_invalid_code_response: 'auth service did not return a usable device code',
    device_code_expired: 'device code expired; run login --device again',
    device_access_denied: 'authorization was denied on the verification page',
    device_2xx_no_token: 'auth service returned 2xx without accessToken',
