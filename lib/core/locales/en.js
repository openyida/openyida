...
`,
    ...
    compile_example: 'Example: openyida compile pages/src/home.jsx',
  ...
  login: {
    ...
    corp_id_ok: '  ✅ corpId: {0}',
    no_playwright: '\n❌ Local browser login requires the optional playwright package. Use openyida login or openyida login --qr by default; install Playwright only if you need local browser login:',
