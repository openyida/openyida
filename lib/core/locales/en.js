...
module.exports = {
  ...
  help: {
    ...
    cmd_flash_to_prd: 'Generate a meeting requirements draft from flash notes or meeting notes',
...
Commands:
  ...
  create-page <appType> "<pageName>" [--source <page.canvas.jsx>] [--mode dashboard] [--hide-nav] Create a custom page, output pageId
...
`,
  ...
  create_page: {
    ...
    usage: 'Usage: openyida create-page <appType> "<pageName>" [--source <page.canvas.jsx>] [--mode dashboard] [--hide-nav]',
  ...
  create_form: {
    ...
    config_pending: '  ⚠️  Config update is still pending: {0}',
    schema_ok_config_failed: '  Schema saved, but config update failed',
    schema_ok_config_pending: '  Schema saved; platform config service is still syncing, retry the config update later',
  ...
  publish: {
    ...
    lint_form_open_container: 'Yida submission, detail, and data-management actions in a custom page must use FormOpenContainer. Data management uses workbench/{formUuid}?hideLeftNav=true&corpid={corpId}. Button handlers should call openForm(request).',
    ...
    lint_formdata_literal_key: 'Do not read formData with field name/label key "{0}"; searchFormDatas returns formData keyed by real fieldId. Use FIELDS generated from get-schema --field-map-json.',
    lint_undefined_seterror: 'setError(...) is called but setError is not bound in the current scope. Destructure setError from useState or useCanvasBaseState to avoid a Canvas runtime ReferenceError.',
    ...
    lint_canvas_yida_api_bridge_missing: 'Code Canvas form data reads must consume window.__OPENYIDA_RUNTIME__.yida or window.__OPENYIDA_YIDA_API__ first (the publish layer injects the this.utils.yida bridge from outer didMount); do not default to handwritten internal searchFormDatas fetch',
    ...
    health_check_skipped: '  ℹ️  Health check skipped: {0}',
    ...
    nav_order_required_failed: 'The page was published, but navigation ordering that keeps custom pages before forms failed: {0}',
    exception: '\n❌ Publish error: {0}',
    error: '\n❌ Publish error: {0}',
...
Options:
  ...
  flashNote: {
    toPrd: {
      title: '📋 DingTalk Flash Note to Meeting Requirements Draft',
      ...
      step_ai: '[Step 5] Calling AI to generate the meeting requirements draft...',
      ...
      ai_success: '✅ Meeting requirements draft generated successfully',
      ai_error: 'AI API call failed: {0}',
      done: '✅ Meeting requirements draft generation complete',
