...
Options:
  ...
  export_conv: {
    help: `
Usage: openyida export-conversation [options]

Export AI conversation logs as structured documents.

Options:
  --output <file>       Output file path (default: conversation-export.md)
  --format <type>       Output format: markdown | json (default: markdown)
  --template <type>     Template style: tutorial | case | qa (default: tutorial)
  --dingtalk <webhook>  Send to DingTalk group (Webhook URL)
  --clear               Clear logs after export
  --list                Show log summary only
...
Examples:
  ...
  openyida export-conversation --clear`,
    ...
    summary_sep: '══════════════════════════════════════════',
    no_logs: '📭 No conversation logs found. Logs are recorded automatically when you run openyida commands.',
    no_logs_hint: '💡 Tip: Run any openyida command (e.g. create-app, publish) and logs will be saved automatically.',
    total_records: '  📝 Total records: {0}',
    commands_used: '  🔧 Commands used: {0}',
    success_count: '  ✅ Success count: {0}',
    error_count: '  ❌ Error count: {0}',
    time_start: '  🕐 Start time: {0}',
    time_end: '  🕐 End time: {0}',
    exported: '✅ Conversation exported to: {0}',
    record_count: '  📝 Contains {0} records',
    step_count: '  📋 Total {0} steps',
    sending_dingtalk: '📤 Sending to DingTalk group...',
    dingtalk_success: '✅ Successfully sent to DingTalk group!',
    dingtalk_failed: '❌ DingTalk send failed: {0}',
    dingtalk_error: '❌ DingTalk send error: {0}',
    dingtalk_timeout: 'DingTalk request timeout',
    cleared: '🗑️  Cleared {0} conversation records',
    log_recorded: '📝 [conversation-logger] Recorded: {0}',
  },
};
