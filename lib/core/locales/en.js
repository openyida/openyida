...
`,
  ...
  publish: {
    ...
    lint_form_open_container: 'Yida form submission/detail actions in a custom page must use the FormOpenContainer drawer by default: a side drawer on desktop and a full-screen drawer on mobile. Button handlers should call openForm({ type: "submission" | "detail", ... }).',
