...
module.exports = {
  ...
  help: {
    ...
    cmd_login: 'Login (cache first, --qr for QR code)',
    ...
    cmd_get_schema: 'Get form Schema',
...
`,
    ...
    integration_help: 'Usage: openyida integration create <appType> <formUuid> <flowName> [options]',
