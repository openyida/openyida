...
`,
    ...
    integration_help: `Usage: openyida integration <subcommand> [args]

Subcommands:
  create <appType> <formUuid> <flowName> [options]   Create integration & automation (logic flow)
...
`,
    ...
    invalid_response: '❌ Failed to create page: invalid pageId returned by server, please check if appType is correct',
  },
