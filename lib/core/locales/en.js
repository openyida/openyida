...
module.exports = {
  agent: {
    ...
    provider_options_required: 'Specify qoder/codex/opencode together with an absolute --provider-path.',
    provider_not_found: 'Qoder, Codex, or OpenCode was not found on PATH. Install a local Agent, or provide --provider and an absolute --provider-path.',
