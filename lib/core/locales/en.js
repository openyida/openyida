...
module.exports = {
  ...
  help: {
    ...
    cmd_data_upload_attachment: 'Upload local files to an attachment field on an existing form instance',
  ...
  attachment_upload: {
    invalid: 'Invalid attachment upload arguments: {0}',
    login_required: 'A valid OpenYida OAuth session is required; run openyida login first',
    stage_failed: 'Attachment upload failed during {0}: {1}',
    partial_failed: 'One or more files failed to upload; the form instance was not updated and OSS orphan objects may exist',
    verification_failed: 'The attachment update completed, but instance read-back verification failed',
  },
