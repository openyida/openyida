...
`,
  ...
  publish: {
    ...
    lint_external_resource_public_cdn: '外部 JS/CSS 資源使用了公共 CDN。宜搭自定義頁面建議改用已驗證的 g.alicdn.com 地址或企業自托管 CDN',
    lint_loadscript_css_file: 'this.utils.loadScript 指向 CSS 文件。CSS 資源請使用 this.utils.loadStyleSheet 載入',
    lint_loadstylesheet_js_file: 'this.utils.loadStyleSheet 指向 JS 文件。JS 資源請使用 this.utils.loadScript 載入',
