...
`,
    ...
    check_page_usage: '用法：openyida check-page <原始檔路徑> [--json]',
    check_page_example: '範例：openyida check-page pages/src/home.jsx --json',
    generate_page_usage: '用法：openyida generate-page product-homepage --output pages/src/home.jsx [--spec page.json] [--compile]',
    generate_page_example: '範例：openyida generate-page product-homepage --brand-name OpenKuma --brand-initials OK --output pages/src/home.jsx --compile',
  ...
  login: {
    ...
    corp_id_ok: '  ✅ corpId：{0}',
    no_playwright: '\n❌ 本機瀏覽器登入需要可選依賴 playwright。預設請使用 openyida login 或 openyida login --qr；如確需本機瀏覽器登入，請先安裝：',
