...
选项:
  ...
  codex_login: {
    ...
    using_browser: 'Codex 内置浏览器仅适合无需登录的页面预览；宜搭登录 Cookie 请使用 openyida login --browser。',
    browser_handoff_hint: 'Codex 内置浏览器不支持认证 Cookie 导出；如需 CLI Cookie，请使用 openyida login --browser。',
    handoff_message: 'Codex 内置浏览器不能导出宜搭登录 Cookie；如需 CLI Cookie，请运行 fallback_command。',
