...
`,
  ...
  publish: {
    ...
    lint_external_resource_public_cdn: '外部 JS/CSS 资源使用了公共 CDN。宜搭自定义页面建议改用已验证的 g.alicdn.com 地址或企业自托管 CDN',
    lint_loadscript_css_file: 'this.utils.loadScript 指向 CSS 文件。CSS 资源请使用 this.utils.loadStyleSheet 加载',
    lint_loadstylesheet_js_file: 'this.utils.loadStyleSheet 指向 JS 文件。JS 资源请使用 this.utils.loadScript 加载',
