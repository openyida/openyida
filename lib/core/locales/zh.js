...
module.exports = {
  ...
  help: {
    ...
    cmd_data_upload_attachment: '上传本地文件到已有表单实例的附件组件',
  ...
  attachment_upload: {
    invalid: '附件上传参数无效：{0}',
    login_required: '无法获取有效的 OpenYida OAuth 登录态，请先运行 openyida login',
    stage_failed: '附件上传在 {0} 阶段失败：{1}',
    partial_failed: '一个或多个文件上传失败；表单实例未更新，可能存在 OSS 孤儿对象',
    verification_failed: '附件已写入，但实例回读验收失败',
  },
