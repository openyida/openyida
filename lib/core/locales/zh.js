...
`,
  ...
  login: {
    ...
    device_title: '设备码登录：',
    device_open: '打开',
    device_enter_code: '输入验证码：',
    device_or_direct: '或直接打开：',
    device_completed: '设备授权完成。',
    device_timeout: '设备授权超时；设备码可能仍在等待验证',
    device_missing_params: '设备码流程需要 authBaseUrl 和 clientId',
    device_poll_missing_params: '设备令牌轮询需要 authBaseUrl、clientId 和 deviceCode',
    device_invalid_code_response: '认证服务未返回可用的设备码',
    device_code_expired: '设备码已过期；请重新执行 login --device',
    device_access_denied: '授权已在验证页面被拒绝',
    device_2xx_no_token: '认证服务返回 2xx 但未包含 accessToken',
