...
module.exports = {
  ...
  help: {
    ...
    cmd_integration_detail_log: '查看集成自动化运行日志详情',
...
`,
    ...
    integration_help: '用法: openyida integration <create|update|list|enable|disable|check|detail-log|diagnose> ...',
  ...
  integration_detail_log: {
    usage: '用法: openyida integration detail-log <appType> <procInstId> [--json] [--include-params]（完整参数需同时指定两个选项；可能包含敏感数据）',
    missing_args: '查询运行日志详情需要 appType 和 procInstId',
    unknown_option: '不支持的运行日志详情选项：{0}',
    params_require_json: '--include-params 必须与 --json 一起使用；完整参数可能包含敏感数据',
    api_failed: '查询运行日志详情失败：{0}',
    invalid_response: '运行日志详情响应缺少有效的节点列表或总数',
    pagination_failed: '运行日志详情分页结果不一致，未输出不完整数据',
    summary: '运行日志详情：{0} 个节点（默认仅显示参数键名）',
  },
