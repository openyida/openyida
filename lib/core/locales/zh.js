...
module.exports = {
  ...
  help: {
    ...
    cmd_check_prd_completeness: '检查 PRD 搭建完整度',
    cmd_er: '导出应用实体关系图',
...
`,
    ...
    check_prd_completeness_usage: '用法: openyida check-prd-completeness <prd.md> --app-type <appType> [--json]',
    check_prd_completeness_example: '示例: openyida check-prd-completeness prd/订单管理/prd.md --app-type APP_XXX --json',
  ...
  check_prd_completeness: {
    usage: '用法: openyida check-prd-completeness <prd.md> --app-type <appType> [--json]',
    example: '示例: openyida check-prd-completeness prd/订单管理/prd.md --app-type APP_XXX --json',
