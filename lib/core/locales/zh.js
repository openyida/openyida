...
选项:
  ...
  export_conv: {
    help: `
用法: openyida export-conversation [选项]
...
示例:
  ...
  openyida export-conversation --output my-tutorial.md --template case
  openyida export-conversation --dingtalk https://oapi.dingtalk.com/robot/send?access_token=xxx
  openyida export-conversation --format json --output data.json
  openyida export-conversation --list
  openyida export-conversation --clear`,
    summary_title: '\n📊 对话记录摘要',
    summary_sep: '══════════════════════════════════════════',
    no_logs: '📭 暂无对话记录。执行 openyida 命令后会自动记录。',
    no_logs_hint: '💡 提示：执行任意 openyida 命令（如 create-app、publish 等）后，对话记录会自动保存。',
    total_records: '  📝 总记录数: {0}',
    commands_used: '  🔧 使用命令: {0}',
    success_count: '  ✅ 成功次数: {0}',
    error_count: '  ❌ 错误次数: {0}',
    time_start: '  🕐 开始时间: {0}',
    time_end: '  🕐 结束时间: {0}',
    exported: '✅ 对话记录已导出到: {0}',
    record_count: '  📝 包含 {0} 条记录',
    step_count: '  📋 共 {0} 个步骤',
    sending_dingtalk: '📤 正在发送到钉钉群...',
    dingtalk_success: '✅ 已成功发送到钉钉群！',
    dingtalk_failed: '❌ 钉钉发送失败: {0}',
    dingtalk_error: '❌ 钉钉发送异常: {0}',
    dingtalk_timeout: '钉钉请求超时',
    cleared: '🗑️  已清除 {0} 条对话记录',
    log_recorded: '📝 [conversation-logger] 已记录: {0}',
  },
};
