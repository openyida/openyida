...
module.exports = {
  agent: {
    ...
    provider_options_required: '指定 provider 时须同时提供 qoder/codex/opencode 和绝对 --provider-path。',
    provider_not_found: '未在 PATH 中找到 Qoder、Codex 或 OpenCode。请先安装本地 Agent，或显式提供 --provider 与绝对 --provider-path。',
