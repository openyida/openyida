...
`,
    ...
    integration_help: '使用方法: openyida integration create <appType> <formUuid> <flowName> [options]',
    ...
    compile_example: '例: openyida compile pages/src/home.jsx',
  ...
  login: {
    ...
    corp_id_ok: '  ✅ corpId: {0}',
    no_playwright: '\n❌ ローカルブラウザログインには任意依存の playwright が必要です。通常は openyida login または openyida login --qr を使用してください。ローカルブラウザログインが必要な場合のみインストールしてください：',
