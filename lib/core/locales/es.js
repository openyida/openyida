...
module.exports = {
  ...
  codex_login: {
    ...
    using_browser: 'Codex in-app Browser is only suitable for unauthenticated page previews; use openyida login --browser for Yida login cookies.',
    browser_handoff_hint: 'Codex in-app Browser does not support authentication Cookie export. Use openyida login --browser when CLI cookies are required.',
    handoff_message: 'Codex in-app Browser cannot export Yida login cookies. Run fallback_command when CLI cookies are required.',
