...
module.exports = {
  ...
  publish: {
    ...
    lint_external_script_public_cdn: 'External script URL uses a public CDN. Prefer a verified g.alicdn.com URL or enterprise-hosted CDN for Yida custom pages',
