...
module.exports = {
  ...
  publish: {
    ...
    lint_external_resource_public_cdn: 'External resource URL uses a public CDN. Prefer a verified g.alicdn.com URL or enterprise-hosted CDN for Yida custom pages',
    lint_loadscript_css_file: 'this.utils.loadScript points to a CSS file. Use this.utils.loadStyleSheet for CSS resources',
    lint_loadstylesheet_js_file: 'this.utils.loadStyleSheet points to a JS file. Use this.utils.loadScript for JS resources',
