 ...
 *
 * 支持的操作：
 *   query form / get form / create form / update form / delete form / upload-attachment form / query subform
...
Usage:
  ...
  openyida data upload-attachment form <appType> <formUuid> --inst-id <formInstId> --attachment-field <attachmentField_xxx> --file <path> [--file <path> ...] [--append] [--concurrency <1-5>] [--dry-run]
...
async function run(args) {
  ...
  if (action === 'upload-attachment' && resource === 'form') {
    return uploadAttachment.run(args.slice(2));
  }
